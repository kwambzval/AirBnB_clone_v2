...
to your web servers, using the function do_deploy, and deletes out-of-date archives,
...
def do_clean(number=0):
    ...
    # delete all unnecessary archives in the /data/web_static/releases folder of the web servers
